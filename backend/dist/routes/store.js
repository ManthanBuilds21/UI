...
router.post('/cart/items', asyncHandler(async (request, response) => {
...
router.patch('/cart/items', asyncHandler(async (request, response) => {
...
router.delete('/cart/items', asyncHandler(async (request, response) => {
...
router.post('/wishlist/toggle', asyncHandler(async (request, response) => {
