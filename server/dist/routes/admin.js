...
router.patch('/orders/:id', asyncHandler(async (request, response) => {
...
router.patch('/products/:id/stock', asyncHandler(async (request, response) => {
    ...
    response.json({
        product: {
            id: updated.id,
            name: updated.name,
            stockBySize: updated.stockBySize,
        },
    });
}));
